...
def alyssa(request):
        ...
        cursor.execute("SELECT sample, dbsnp_ins_del_ratio, num_singletons, company, mean_target_coverage, median_target_coverage, pct_target_bases_10x, pct_target_bases_20x, pct_target_bases_30x, pct_chimeras, contamination, het_homvar_ratio, total_snps, pct_dbsnp, dbsnp_titv, novel_titv, total_indels, pct_dbsnp_indels, novel_ins_del_ratio FROM gc_2 ORDER BY company")
        ...
        try:
                ...
                col_json.append({'label': 'medtc', 'type': 'number'})
